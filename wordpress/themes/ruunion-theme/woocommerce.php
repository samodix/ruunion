...
<section class="ru-page-hero ru-page-hero--shop">
	<div class="ru-container ru-page-hero__split">
		<div>
			<span class="ru-pill">Boutique solidaire · WooCommerce</span>
			<h1><?php woocommerce_page_title(); ?></h1>
			<p>Chaque pack aide à faire avancer une histoire, une production et un engagement humain. L’expérience reste WooCommerce, avec une interface RU Union plus fluide.</p>
