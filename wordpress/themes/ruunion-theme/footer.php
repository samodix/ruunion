...
<footer class="ru-footer">
	...
	<div class="ru-container">
		<div class="ru-footer__intro"><a class="footer-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php esc_attr_e( 'Accueil RU Union', 'ruunion-theme' ); ?>"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/logo-ruunion.webp' ); ?>" alt="<?php echo esc_attr( 'RU Union — L’union des plus humains' ); ?>" width="440" height="240"></a><h2>L’union des plus humains</h2><p>Des films, des récits et des actions pour créer du lien, soutenir les projets humains et faire grandir une solidarité concrète.</p></div>
