...
$image = $film ? ruunion_theme_film_image( $film->ID, 'full' ) : ruunion_theme_asset_image( 'illustrations/illustrations-ruunion.webp' );
...
<section class="ru-hero ru-hero--cinematic">
	...
	<div class="ru-container ru-hero__grid">
		<div class="ru-hero__copy" data-ru-reveal>
			<span class="ru-pill">Films solidaires آ· Projets humains</span>
			<h1>Des histoires qui rapprochent <em>les plus humains</em></h1>
			<p>RU Union produit et accompagne des rأ©cits cinأ©matographiques qui transforment lâ€™أ©motion en soutien concret. Chaque image ouvre une rencontre, chaque contribution fait avancer un projet.</p>
			<div class="ru-actions">
				<a class="ru-button ru-button--primary" href="<?php echo esc_url( get_post_type_archive_link( 'film' ) ?: ruunion_theme_page_url( 'films' ) ); ?>">Dأ©couvrir les films <span aria-hidden="true">â†’</span></a>
			...
			<div class="ru-hero__markers" aria-label="<?php esc_attr_e( 'Axes du projet', 'ruunion-theme' ); ?>">
				<span>Production indأ©pendante</span><span>Impact humain</span><span>أ‰lan collectif</span>
			</div>
			<div class="ru-stats">
				...
				<div class="ru-stat-goal"><span>Objectif</span><strong><?php echo esc_html( number_format_i18n( (float) $stats['goal'], 0 ) ); ?> €</strong></div>
		...
		<div class="ru-hero__visual has-image" style="background-image:url('<?php echo esc_url( $image ); ?>')" data-ru-parallax>
			...
			<span class="ru-status">En lumiأ¨re</span>
			...
			<div class="ru-hero__film">
				<span>Film sأ©lectionnأ©</span>
				<h2><?php echo esc_html( $film ? get_the_title( $film ) : 'Parce que câ€™est toi' ); ?></h2>
				<p><?php echo esc_html( $film ? ruunion_theme_meta( $film->ID, 'synopsis_court', $film->post_excerpt ) : 'Un rأ©cit intime sur les liens qui nous relأ¨vent.' ); ?></p>
			</div>
			<div class="ru-collection">
				...
				<small><?php echo wp_kses_post( ruunion_theme_money( $stats['collected'] ) ); ?> rأ©unis</small>
			</div>
		</div>
	</div>
</section>
